...
const NeZCData *human9DOF_836bb176_1_ZCData = NULL;
PmfMessageId human9DOF_836bb176_1_computeAsmModeVector(const double *input,
...
PmfMessageId human9DOF_836bb176_1_computeSimModeVector(const double *input,
  const double *inputDot, const double *inputDdot, int *modeVector, double
  *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId human9DOF_836bb176_1_computeZeroCrossings(const

...
#include "nesl_rtw.h"
#include "human9DOF_836bb176_1.h"
#include "human9DOF_836bb176_1_gateway.h"

void human9DOF_836bb176_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 0, 0, 0.0001, 0, 0,
    0, 0, (SscLoggingSetting) 0, 541546362, };
  ...
  human9DOF_836bb176_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("human9DOF/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
